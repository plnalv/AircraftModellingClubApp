...
import by.aliyeva.aircraftmodellingclub.repositories.ProductRepository;
import by.aliyeva.aircraftmodellingclub.repositories.UserRepository;
        ...
        if (product != null) {
            if (product.getUser().getId().equals(user.getId())) {
                ...
                for(CartItem item : cartItems) {
                    ...
                    cartService.removeItemFromCart(cart.getUser(), item.getId());
